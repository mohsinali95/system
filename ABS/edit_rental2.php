...
<br><br>
 <div class="container-fluid">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">&nbsp;Edit Library Fees</div>
                        ...
                        <div class="panel-body">
							...
							<!--------------------form------------------->
							  ...
							  <?php 
									...
									echo "<input id='rental' name='rental2' type='text' onChange='updatesum()' 
									value='".$rental2."' class='form-control input-md'>";
							  ?>
							<br>
						        <button name="update" class="btn btn-success">Update</button>
						        <a button name="cancel" class="btn btn-primary" href="rental2.php">Cancel</a></button>
						    </div>
						...
						if (($_POST['rental2'] == ''))
						{
							...
							$r = addslashes("$_POST[rental2]");
							{
							}
							//dri nah mah edit xng data
							mysql_query("UPDATE room SET rental2 ='$r' where room_id='$id'")or die(mysql_error()); 
					}?>
							<script>
							alert('Updated Successfully');
							window.location = "rental2.php";
							</script>
							<?php
							}?>  
                            </div>                          
