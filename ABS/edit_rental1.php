...
<br><br>
 <div class="container-fluid">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">&nbsp;Edit Annual Fees</div>
                        ...
                        <div class="panel-body">
							...
							<!--------------------form------------------->
							  ...
							  <?php 
									...
									echo "<input id='rental1' name='rental1' type='text' onChange='updatesum()' 
									value='".$rental1."' class='form-control input-md'>";
							  ?>
							<br>
						        <button name="update" class="btn btn-success">Update</button>
						        <a button name="cancel" class="btn btn-primary" href="rental1.php">Cancel</a></button>
						    </div>
						...
						if (($_POST['rental1'] == ''))
						{
							...
							$r = addslashes("$_POST[rental1]");
							{
							}
							//dri nah mah edit xng data
							mysql_query("UPDATE room SET rental1 ='$r' where room_id='$id'")or die(mysql_error()); 
					}?>
							<script>
							alert('Updated Successfully');
							window.location = "rental1.php";
							</script>
							<?php
							}?>  
                            </div>                          
