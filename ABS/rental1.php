...
<div id="page-wrapper">
            <div class="container-fluid">
				...
				<nav>
				<head>
				<center><h4><strong>Annal Test Fees</strong><h4></center>
					   <div class="col-sm-12">
                                ...
                                <div class="span12">
									...
									<thead>
										  ...
										  <th></th>
												...
												<th><center><strong>Annual Test Fees Amount</strong></center></th>
												<th></th>
										   </tr>
										</thead>
										<tbody>
									<?php
												...
												<td width="100"><input type='text' readonly class="form-control input-md" value="<?php echo $row['rental1']; ?>"></td>
												<td class="col-md-1">
