            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered datatable" id="table_export">
                	<thead>
                		<tr>
                    		<th><div>Class</div></th>
                            <th><div>Monthly Fee</div></th>
                    		<th><div>Admission Fee</div></th>
                            <th><div>Annual Charges</div></th>
                            <th><div>Lab Charges</div></th>
                    		<th><div>Options</div></th>
						</tr>
					</thead>
                    <tbody>
                    	<?php foreach($fee_structure as $row):?>
                        <tr>
							<td><?php echo $this->db->where('class_id', $row['class_id'])->get('class')->row()->name; ?></td>
                            <td><?= $row['amount'] ?></td>
							<td><?= $row['admission'] ?></td>
                            <td><?= $row['annual'] ?></td>
                            <td><?= $row['lab'] ?></td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <!-- EDITING LINK -->
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_fee/<?= $row['fee_id'] ?>');">
                             ...
                             <!-- <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="section_id" class="form-control" style="width:100%;">
                                        ...
                                        foreach($classes as $row):
                                        ?>
                                            <option value="<?php echo $row['section_id'];?>"><?php echo $row['nick_name'];?>&nbsp;<?php echo $row['name'];?></option>
                                        <?php
                                        endforeach;
                                        ?>
                                    </select>
