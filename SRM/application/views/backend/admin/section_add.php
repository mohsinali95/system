			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/sections/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                	...
                	<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="nick_name" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus>
						</div>
					</div>
                              ...
                              <?php 
									...
									foreach($classes as $row):
                                		...
                                		<option value="<?php echo $row['class_id'];?>">
												<?php echo $row['name_numeric'];?>&nbsp;<?php echo $row['name'];?>
                                                </option>
                                    <?php
									endforeach;
								?>
