			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('G.R number');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" name="roll" id="grno" value="" >
						</div>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Father name');?></label>
    ...
    // }
		$(document).ready(function(){
			$('#grno').focusout(function(){
				var id = $(this).val();
				$.ajax({
					url: '<?php echo base_url(); ?>index.php?admin/check_grno/'+id,
					success: function(response){
						if(response == 1){
							$("#gr_res").show();
						}else{
