<hr />
	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
		...
		<tbody>
        	<form method="post" action="<?php echo base_url();?>index.php?admin/attendance_selector_teacher" class="form">
            	<tr class="gradeA">
                    <td>
                     ...
                     <!-- <td>
                        <select name="section_id" class="form-control">
                            ...
                            <option value="<?php echo $row['section_id'];?>"
                                <?php if(isset($section_id) && $section_id==$row['section_id'])echo 'selected="selected"';?>>
                        ...
                        <tr class="gradeA">
                            ...
                            <?php 
                                ...
                                $verify_data    =   array(  'teacher_id' => $row['teacher_id'],
                                                            'date' => $full_date);
                                $query = $this->db->get_where('teacher_attendance' , $verify_data);
                                if($query->num_rows() < 1)
                                $this->db->insert('teacher_attendance' , $verify_data);
...
<form method="post" 
    action="<?php echo base_url();?>index.php?admin/manage_attendance_teacher/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered">
        		<thead>
        			<tr class="gradeA">
