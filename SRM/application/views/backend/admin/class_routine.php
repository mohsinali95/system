		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo get_phrase('course_schedule_list');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo get_phrase('add_course_schedule');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
                	...
                	<?php echo form_open(base_url() . 'index.php?admin/class_routine/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="class_id" class="form-control" style="width:100%;"
										...
										foreach($classes as $row):
										?>
                                    		<option value="<?php echo $row['class_id'];?>"><?php echo $row['name_numeric'];?>&nbsp;<?php echo $row['name'];?></option>
                                        <?php
										endforeach;
										?>
                                    </select>
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo get_phrase('add_class_schedule');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
