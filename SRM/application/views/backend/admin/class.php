		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo get_phrase('classes_list');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo get_phrase('add_a_class');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->db->select('name')->where('teacher_id',$row['teacher_id'])->get('teacher')->row()->name; ?></td>
							<td>
                            <div class="btn-group">
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                           ...
                           <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Class Teacher');?></label>
                                <div class="col-sm-5">
