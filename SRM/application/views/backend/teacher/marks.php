            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                	<tr>
                        ...
                        <td><?php echo get_phrase('select_year_&_section');?></td>
                	...
                	<tr>
                        ...
                        <td>
                            <select name="section_id" class="form-control" style="float:left;">
                                <option value=""><?php echo get_phrase('select_a_year_&_section');?></option>
                                <?php 
                                ...
                                ?>
                                    <option value="<?php echo $row['section_id'];?>"
                                        <?php if($section_id == $row['section_id'])echo 'selected';?>>
                                             <?php echo $row['nick_name'];?>&nbsp;<?php echo $row['name'];?></option>
                                <?php
                                endforeach;
                                ?>
                            </select>
